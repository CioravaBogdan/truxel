...
export default function ForgotPasswordScreen() {
  ...
  const onSubmit = async (data: ForgotPasswordForm) => {
    ...
    try {
      ...
      Toast.show({
        type: 'success',
        text1: t('auth.reset_email_sent'),
        text2: t('auth.check_email_reset'),
      });
        ...
        >
          <View style={styles.headerContent}>
            <Image 
              ...
              resizeMode="contain"
            />
            <Text style={styles.headerTitle}>{t('auth.forgot_password')}</Text>
            <Text style={styles.headerSubtitle}>{t('auth.forgot_password_subtitle')}</Text>
          </View>
        </LinearGradient>
