  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>2. Data Controller</Text>
          <Text style={styles.text}>
            Company Name: Truxel{'\n'}
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.subheading}>3.1 Personal Information</Text>
          <Text style={styles.text}>
            • Full name{'\n'}
            • Email address{'\n'}
            • Phone number{'\n'}
          ...
          <Text style={styles.subheading}>3.2 Location Data</Text>
          <Text style={styles.text}>
          ...
          <Text style={styles.subheading}>3.4 Payment Information</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>6. Sharing Your Information</Text>
          <Text style={styles.subheading}>We share your data with:</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>9. Your Rights (GDPR)</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>10. How to Exercise Your Rights</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>13. Security</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>14. Changes to This Policy</Text>
          <Text style={styles.text}>
