  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>5. Service Description</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>6. Subscription Plans and Pricing</Text>
          <Text style={styles.subheading}>6.1 Available Plans</Text>
          <Text style={styles.text}>
          ...
          <Text style={styles.subheading}>6.2 Billing and Payment</Text>
          <Text style={styles.text}>
          ...
          <Text style={styles.subheading}>6.3 Automatic Renewal</Text>
          <Text style={styles.text}>
          ...
          <Text style={styles.subheading}>6.4 Cancellation</Text>
          <Text style={styles.text}>
          ...
          <Text style={styles.subheading}>6.5 Upgrades and Downgrades</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>7. Search Credits</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>8. Acceptable Use Policy</Text>
          <Text style={styles.text}>
            You agree NOT to:{'\n'}
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>9. Community Guidelines</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>10. Intellectual Property</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>11. Data Accuracy and Liability</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>15. Changes to Terms</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>16. Privacy</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>17. Dispute Resolution</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>18. Force Majeure</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>19. Severability</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>21. Contact Information</Text>
          <Text style={styles.text}>
