...
export default function DataDeletion() {
  ...
  const seoDescription =
    'Instructiuni clare pentru stergerea contului si a datelor din platforma Truxel, in conformitate cu GDPR si politicile magazinelor de aplicatii.';

  return (
    <>
      <SeoHead
        title="Stergere date si cont | Truxel"
        ...
        <View style={styles.content}>
          ...
          <View style={styles.section}>
            ...
            <Text style={[styles.text, { color: theme.colors.textSecondary }]}>
              At Truxel, we respect your right to control your data. In compliance with GDPR and App Store guidelines,
              we provide a simple way for you to request the deletion of your account and all associated data.
            </Text>
          </View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.stepsContainer}>
              ...
              <Text style={[styles.stepDesc, { color: theme.colors.textSecondary }]}>
                Read the warning and confirm your choice. You may be asked to re-authenticate.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.section}>
            ...
            <Text style={[styles.text, { color: theme.colors.textSecondary }]}>
              Some data may be retained for legal or accounting purposes, such as transaction records for purchases made
              through Stripe or app stores, as required by law. This data is not linked to your active profile and is stored securely.
            </Text>
          </View>
