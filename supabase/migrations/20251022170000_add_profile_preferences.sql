...
ADD COLUMN IF NOT EXISTS search_radius_km INTEGER DEFAULT 10 CHECK (search_radius_km IN (1, 5, 10, 25, 50)),
...
COMMENT ON COLUMN profiles.search_radius_km IS 'Default search radius in kilometers (1, 5, 10, 25, 50)';
